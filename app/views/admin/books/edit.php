            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="old_price" id="old_price" value="<?= $data['buku']['old_price'] ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-unsoed-blue focus:border-unsoed-blue outline-none transition">
                    </div>
                </div>
