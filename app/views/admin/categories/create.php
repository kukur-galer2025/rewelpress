<div class="p-6 md:p-10">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-1">Tambah Kategori</h1>
            <p class="text-gray-500 text-sm">Buat kategori baru atau subkategori.</p>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <label class="flex items-center gap-2 cursor-pointer bg-gray-50 px-4 py-3 border border-gray-200 rounded-xl flex-1 hover:border-unsoed-blue transition-colors">
                            <input type="radio" name="category_type" value="main" class="text-unsoed-blue focus:ring-unsoed-blue w-4 h-4" checked onclick="toggleParentSelect()">
                            <span class="font-medium text-gray-700">Kategori Utama</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer bg-gray-50 px-4 py-3 border border-gray-200 rounded-xl flex-1 hover:border-unsoed-blue transition-colors">
                            <input type="radio" name="category_type" value="sub" class="text-unsoed-blue focus:ring-unsoed-blue w-4 h-4" onclick="toggleParentSelect()">
                            <span class="font-medium text-gray-700">Sub-Kategori</span>
                        </label>
                    </div>
                </div>

                <div id="parent_select_container" class="hidden transition-all duration-300">
                    ...
                    <select name="parent_id" id="parent_id" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-unsoed-blue/30 focus:border-unsoed-blue transition-all">
