...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
        ...
        <div>
            <p class="text-gray-500 text-sm font-semibold">Pesanan Baru</p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
        ...
        <div>
            <p class="text-gray-500 text-sm font-semibold">Total User</p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
        ...
        <div>
            <p class="text-gray-500 text-sm font-semibold">Pendapatan</p>
