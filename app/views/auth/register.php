...
<?= csrf_field() ?><div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="tel" name="phone" id="phone" class="w-full pl-11 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-unsoed-blue/20 focus:border-unsoed-blue transition-all" placeholder="08123456789" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" id="password" class="w-full pl-11 pr-12 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-unsoed-blue/20 focus:border-unsoed-blue transition-all" placeholder="Min 8 karakter, huruf besar, angka & simbol" minlength="8" required>
